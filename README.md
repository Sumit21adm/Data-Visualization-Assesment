...
#### 1. Total Matches Played In IPL From 2008-2021
    ...
    print(str1 + str(str2))
![Visualization 1](https://github.com/Sumit21adm/Data-Visualization-Assesment/blob/28c12408ca6734e85559addb1071a06cb89f7bd6/Visualisation%20Outputs/visual0.png)
